(function (jq) {
    ...
    posters.prototype = {
        ...
        initContent: function () {
            ...
            this.parent.find(".contentHolderUnit:nth-child(" + pre2 + ")").css({ opacity: this.opacity, left: this.pre2Left + 'px', height: this.page3Height+"px", width: this.page3Width+"px", zIndex: 1, marginTop: '150px' });
            this.parent.find(".contentHolderUnit:nth-child(" + next2 + ")").css({ opacity: this.opacity, left: this.next2Left + 'px', height: this.page3Height+"px", width: this.page3Width+"px", zIndex: 1, marginTop: '150px' });
        },
        bind: function () {
        ...
        turnpage: function (page, dir) {
            ...
            var run = function (page, dir, t) {
                ...
                if (dir == 'left') {
                    ...
                    _this.parent.find(".contentHolderUnit:nth-child(" + pre3 + ")").animate({ width: _this.page3Width+"px", height: _this.Page3Height+"px", opacity: 0, left: _this.disappearLeft + 'px', zIndex: 1, marginTop: '150px' }, t);
                    _this.parent.find(".contentHolderUnit:nth-child(" + pre4 + ")").animate({ width: _this.page3Width+"px", height: _this.Page3Height+"px", opacity: 0, left: _this.disappearLeft + 'px', zIndex: 0, marginTop: '150px' }, t);
                    ...
                    _this.parent.find(".contentHolderUnit:nth-child(" + pre2 + ")").animate({ width: _this.page3Width+"px", height: _this.page3Height+"px", opacity: _this.opacity, left: _this.pre2Left + 'px', zIndex: 2, marginTop: '150px' }, t);
                    _this.parent.find(".contentHolderUnit:nth-child(" + next2 + ")").animate({ width: _this.page3Width+"px", height:_this.page3Height+"px", opacity: _this.opacity, left: _this.next2Left + 'px', zIndex: 2, marginTop: '150px' }, t, "", function () { _this.locked = false; });
                    ...
                    _this.parent.find(".contentHolderUnit:nth-child(" + next3 + ")").animate({ width: _this.page3Width+"px", height: _this.Page3Height+"px", opacity: 0, left: _this.disappearRight + 'px', zIndex: 1, marginTop: '150px' }, t);
                    _this.parent.find(".contentHolderUnit:nth-child(" + next4 + ")").animate({ width: _this.page3Width+"px", height: _this.Page3Height+"px", opacity: 0, left: _this.disappearRight + 'px', zIndex: 0, marginTop: '150px' }, t);
                    _this.parent.find(".contentHolderUnit:nth-child(" + page + ")").animate({ opacity: 1, left: _this.pageNowLeft + 'px', height: _this.pageNowHeight+"px", width: _this.pageNowWidth+"px", zIndex: 4, marginTop: '0' }, t);
                    _this.parent.find(".contentHolderUnit:nth-child(" + next + ")").animate({ opacity: _this.opacity, left: _this.nextLeft + "px", height:_this.page2Height+"px", width: _this.page2Width+"px", zIndex: 3, marginTop: '75px' }, t);
                    _this.parent.find(".contentHolderUnit:nth-child(" + pre + ")").animate({ opacity: _this.opacity, left: _this.preLeft + "px", height:_this.page2Height+"px", width: _this.page2Width+"px", zIndex: 3, marginTop: '75px' }, t);
                    _this.parent.find(".contentHolderUnit:nth-child(" + next2 + ")").animate({ width: _this.page3Width+"px", height: _this.page3Height+"px", opacity: _this.opacity, left: _this.next2Left + 'px', zIndex: 2, marginTop: '150px' }, t);
                    _this.parent.find(".contentHolderUnit:nth-child(" + pre2 + ")").animate({ width: _this.page3Width+"px", height:_this.page3Height+"px", opacity: _this.opacity, left: _this.pre2Left + 'px', zIndex: 2, marginTop: '150px' }, t, "", function () { _this.locked = false; });
